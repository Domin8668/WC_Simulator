...
CREATE TABLE `team` (
  ...
  `group_letter` enum('A','B','C','D','E','F','G','H') DEFAULT NULL,
...
INSERT INTO `team` VALUES (1,'A','Katar','QAT','Félix Sánchez Bas',0.5,0.5),(2,'A','Ekwador','ECU','Gustavo Alfaro',0.5,0.5),(3,'A','Senegal','SEN','Aliou Cissé',0.5,0.5),(4,'A','Holandia','NED','Louis van Gaal',0.5,0.5),(5,'B','Anglia','ENG','Gareth Southgate',0.5,0.5),(6,'B','Iran','IRN','Dragan Skočić',0.5,0.5),(7,'B','Stany Zjednoczone','USA','Gregg Berhalter',0.5,0.5),(8,'B','Walia','WAL','Robert Page',0.5,0.5),(9,'C','Argentyna','ARG','Lionel Scaloni',0.5,0.5),(10,'C','Arabia Saudyjska','KSA','Hervé Renard',0.5,0.5),(11,'C','Meksyk','MEX','Gerardo Martino',0.5,0.5),(12,'C','Polska','POL','Czesław Michniewicz',0.5,0.5),(13,'D','Francja','FRA','Didier Deschamps',0.5,0.5),(14,'D','Australia','AUS','Graham Arnold',0.5,0.5),(15,'D','Dania','DEN','Kasper Hjulmand',0.5,0.5),(16,'D','Tunezja','TUN','Mondher Kebaier',0.5,0.5),(17,'E','Hiszpania','ESP','Luis Enrique',0.5,0.5),(18,'E','Kostaryka','CRC','Luis Fernando Suárez',0.5,0.5),(19,'E','Niemcy','GER','Hans-Dieter Flick',0.5,0.5),(20,'E','Japonia','JPN','Hajime Moriyasu',0.5,0.5),(21,'F','Belgia','BEL','Roberto Martínez',0.5,0.5),(22,'F','Kanada','CAN','John Herdman',0.5,0.5),(23,'F','Maroko','MAR','Vahid Halilhodžić',0.5,0.5),(24,'F','Chorwacja','CRO','Zlatko Dalić',0.5,0.5),(25,'G','Brazylia','BRA','Tite',0.5,0.5),(26,'G','Serbia','SRB','Dragan Stojković',0.5,0.5),(27,'G','Szwajcaria','SUI','Murat Yakın',0.5,0.5),(28,'G','Kamerun','CMR','Rigobert Song',0.5,0.5),(29,'H','Portugalia','POR','Fernando Santos',0.5,0.5),(30,'H','Ghana','GHA','Otto Addo',0.5,0.5),(31,'H','Urugwaj','URU','Diego Alonso',0.5,0.5),(32,'H','Korea Południowa','KOR','Paulo Bento',0.5,0.5);
...
INSERT INTO `user` VALUES (1,'admin',_binary 'PJ��U�H��)�4⣳4\�G\�|w>��>܎','2022-06-15 21:47:06','2022-06-18 20:33:15','Jak ma na nazwisko najlepszy napastnik?',_binary '���\�Z>iW\n�\�� \Z\0\�-V\�Q\�^\�F�矮');
